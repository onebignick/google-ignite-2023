...
USERS = [
    (
        ...
        "handy@mandy.com",
        "root",
        "https://static.wikia.nocookie.net/no-game-no-life/images/d/dc/Shiro_Anime_HQ.png/revision/latest?cb=20210523001016",
    ),
    (
        "1900-01-01",
        "f",
...
POSTS = [
    (
        ...
        "I'm overwhelmed because I feel like I'm doing everything wrong",
        "subtitle",
    ...
    (
        1,
        "All about Dementia",
        "What is dementia, dementia affects the brain, resulting in memory loss.",
        "subtitle",
        datetime.datetime.now(),
        1,
        5,
...
print(
    imported_libs["tables.center_type"].load_center_type_table(
        cursor=cur, connection=db, center_types=CENTER_TYPES
    )
)
...
print(
    imported_libs["tables.user"].load_user_table(cursor=cur, connection=db, users=USERS)
)
...
print(
    imported_libs["tables.post"].load_post_table(cursor=cur, connection=db, posts=POSTS)
)
